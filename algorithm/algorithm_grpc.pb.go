...
type AlgorithmServiceClient interface {
	...
	Run(ctx context.Context, in *RunRequest, opts ...grpc.CallOption) (*api.Response, error)
}
...
func (c *algorithmServiceClient) Run(ctx context.Context, in *RunRequest, opts ...grpc.CallOption) (*api.Response, error) {
...
type AlgorithmServiceServer interface {
	...
	Run(context.Context, *RunRequest) (*api.Response, error)
...
func (UnimplementedAlgorithmServiceServer) Run(context.Context, *RunRequest) (*api.Response, error) {
