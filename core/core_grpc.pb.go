...
func (c *mediaLibraryServiceClient) Mkdir(ctx context.Context, in *MediaLibraryDirMkDirRequest, opts ...grpc.CallOption) (*api.Response, error) {
	out := new(api.Response)
	err := c.cc.Invoke(ctx, "/core.MediaLibraryService/Mkdir", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mediaLibraryServiceClient) DeleteFiles(ctx context.Context, in *MediaLibraryDeleteRequest, opts ...grpc.CallOption) (*api.Response, error) {
	out := new(api.Response)
	err := c.cc.Invoke(ctx, "/core.MediaLibraryService/DeleteFiles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MediaLibraryService_Mkdir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/core.MediaLibraryService/Mkdir",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MediaLibraryService_DeleteFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/core.MediaLibraryService/DeleteFiles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
