...
const (
	...
	MediaLibraryService_DeleteFiles_FullMethodName      = "/core.MediaLibraryService/DeleteFiles"
)
...
type MediaLibraryServiceClient interface {
	...
	DeleteFiles(ctx context.Context, in *MediaLibraryDeleteRequest, opts ...grpc.CallOption) (*api.Response, error)
}
...
func (c *mediaLibraryServiceClient) DeleteFiles(ctx context.Context, in *MediaLibraryDeleteRequest, opts ...grpc.CallOption) (*api.Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.Response)
	err := c.cc.Invoke(ctx, MediaLibraryService_DeleteFiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MediaLibraryServiceServer interface {
	...
	DeleteFiles(context.Context, *MediaLibraryDeleteRequest) (*api.Response, error)
...
func (UnimplementedMediaLibraryServiceServer) DeleteFiles(context.Context, *MediaLibraryDeleteRequest) (*api.Response, error) {
...
func _MediaLibraryService_DeleteFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MediaLibraryDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediaLibraryServiceServer).DeleteFiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediaLibraryService_DeleteFiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaLibraryServiceServer).DeleteFiles(ctx, req.(*MediaLibraryDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MediaLibraryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MediaLibraryService_DeleteFiles_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "core/core.proto",
