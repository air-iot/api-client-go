...
const (
	SyslogService_Query_FullMethodName = "/syslog.SyslogService/Query"
)
...
func (c *syslogServiceClient) Query(ctx context.Context, in *api.QueryRequest, opts ...grpc.CallOption) (*api.Response, error) {
	...
	err := c.cc.Invoke(ctx, SyslogService_Query_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SyslogService_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SyslogService_Query_FullMethodName,
	}
